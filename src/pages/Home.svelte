...
<Row>
  <Card
    title={"Pesquisa Desk"}
    text={`Um dos principais problemas enfrentados no site da prefeitura de Niterói e de
  ...
  <Card
    title={"Personas"}
    text={`
    <h4>Fábio Assunção</h4>
    <p>Esse cara tá malhando muito agora!</p>
    <ul>
      <li>
        <strong>Ponto forte:</strong> Bebe muito!  
      </li>  
      <li>
        <strong>Ponto fraco:</strong> <strike>Cheira</strike> muito!  
      </li>  
    </ul>
    `}
  />
